...
ArbolSintactico *ArbolSintactico::Bin(const String &raiz, ArbolSintactico *izq, ArbolSintactico *der)
{
    return new ArbolSintactico(raiz, izq, der);
}
